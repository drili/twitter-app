        ...
        <div className="hidden lg:inline ml-8 xl:w-[450px] py-1 space-y-5">
            <div className="sticky top-0 py-1.5 bg-black z-50 w-11/12 xl:w-9/12">
                <div className="flex items-center bg-[#202327] p-3 rounded-full relative">
                    <SearchIcon className="text-gray-500 h-5 z-50"></SearchIcon>
                    <input
                        type="text"
            ...
            <div className="text-[#d9d9d9] space-y-3 bg-[#15181c] pt-2 pb-2 rounded-xl w-11/12 xl:w-9/12">
                ...
                <button className="hover:bg-white hover:bg-opacity-[0.03] px-4 pt-3 cursor-pointer transition duration-200 ease-out flex items-center justify-between w-full text-[#1d9bf0] font-light">
                    Show more
                </button>
            </div>
            ...
            <div className="text-[#d9d9d9] space-y-3 bg-[#15181c] pt-2 pb-2 rounded-xl w-11/12 xl:w-9/12">
                ...
                {followResults.map((result, index) => (
                    <div
                        key={index} 
                        className="hover:bg-white hover:bg-opacity-[0.03] px-4 pt-3 cursor-pointer transition duration-200 ease-out flex items-center"
                    >
                        <Image
                            src={result.userImg}
                            width={50}
                        ...
                        <div className="ml-4 leading-5 group">
                            ...
                            <h5 className="text-grey-500 text-[15px]">{result.tag}</h5>
                        </div>
