                              ...
                              <div className="flex items-center">
                                   <div className="icon" onClick={() => filePickerRef.current.click()}>
                                        ...
                                        <input
                                             type="file"
                                             hidden
                                             onChange={addToImageToPost}
                                             ref={filePickerRef}/>
                                   </div>

                                   <div className="icon rotate-90">
                                        <ChartBarIcon className="text-[#1d9bf0] h-[22px]"></ChartBarIcon>
                                   </div>

                                   <div className="icon" onClick={() => setShowEmojis(!showEmojis)}>
                                        <EmojiHappyIcon className="text-[#1d9bf0] h-[22px]"></EmojiHappyIcon>
                                   </div>

                                   <div className="icon">
                                        <CalendarIcon className="text-[#1d9bf0] h-[22px]"></CalendarIcon>
                                   </div>
